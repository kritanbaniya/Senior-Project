...
const mainItems: SidebarItem[] = [
  { title: "Dashboard",  url: "/dashboard/nurse",             icon: LayoutDashboard },
  { title: "My Profile", url: "/dashboard/nurse/information", icon: UserRound },
]

const workItems: SidebarItem[] = [
  { title: "Appointments",      url: "/dashboard/nurse/appointments", icon: CalendarClock },
  { title: "Queue Management",  url: "/dashboard/nurse/queue",        icon: ListOrdered },
        ...
        <div className="flex items-center justify-between gap-2 group-data-[collapsible=icon]:justify-center">
          <div className="flex min-w-0 items-center gap-2 group-data-[collapsible=icon]:hidden">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[11px] text-[#4a3fa8]">Nurse Portal</p>
            </div>
          </div>
